...
<form:form action="manager/edit.do" modelAttribute="manager">
	...
	<!-- Managers inputs -->
	<form:label path="banned">
		<spring:message code="manager.banned" />:
		</form:label>
	...
	<input type="button" name="cancel"
		value="<spring:message code="actor.cancel" />" <%-- onclick="javascript: relativeRedir('actor/administrator/list.do');" --%> />
	<br />
